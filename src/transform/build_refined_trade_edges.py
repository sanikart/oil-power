#!/usr/bin/env python3
"""Build canonical bilateral refined petroleum trade edges from CEPII BACI."""
...
OUTPUT_PATH = ROOT / "data" / "canonical" / "refined_trade_edges.csv"
...
def main() -> None:
    ...
    edge_totals: dict[tuple[int, str, str], dict[str, float | int | str]] = {}
