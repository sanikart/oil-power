#!/usr/bin/env python3
"""Export compact bilateral crude petroleum trade JSON for the p5 app."""
...
INPUT_PATH = ROOT / "data" / "canonical" / "crude_trade_edges.csv"
OUTPUT_PATH = ROOT / "app" / "public" / "data" / "crude_trade_edges.json"
...
def main() -> None:
    if not INPUT_PATH.exists():
        raise SystemExit(f"missing {INPUT_PATH}; run src/transform/build_crude_trade_edges.py")
    ...
    payload = {
        "metadata": {
            "title": "Bilateral crude petroleum trade edges",
            "source": "CEPII BACI HS17 V202601, product 270900 crude petroleum",
